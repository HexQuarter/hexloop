    ...
    return (
        <Dialog open={open} onOpenChange={handleOpenChange}>
            <DialogTrigger asChild onClick={() => handleOpenChange(true)} >
                <Button className="w-full hover:scale-110 transition-all duration-300" >
                    Send
                </Button>
            </DialogTrigger>
            <DialogContent className="bg-gray-50">
                ...
                <Tabs defaultValue="spark" className="flex flex-col gap-10" onValueChange={onTabChange} value={method}>
                    <TabsList className="bg-transparent p-0">
                        ...
                        <TabsTrigger value={"bitcoin"} className="p-5 data-[state=active]:bg-primary/10! data-[state=active]:text-primary data-[state=active]:border-1 data-[state=active]:border-primary/20 rounded-full text-gray-400">Bitcoin</TabsTrigger>
                    </TabsList>
                    <TabsContent value="spark">
                        <Card className="w-full">
                            <CardHeader>
                                <CardTitle>Send via Spark</CardTitle>
                                <CardDescription>Instant and free transfers between Spark users with complete privacy.</CardDescription>
                            </CardHeader>
                            <CardContent>
                                    ...
                                    <form>
                                        <div className="flex flex-col gap-4 my-4">
                                            ...
                                            <div className="grid gap-3">
                                                ...
                                                {amount > selectedAsset.max && <span className="items-center flex text-sm text-primary font-semibold">Insufficient funds. The amount entered is greater than your balance ({selectedAsset.max} {selectedAsset.symbol})</span>}
                    ...
                    <TabsContent value="bitcoin" className="flex gap-5">
                        <Card className=" w-full">
                            <CardHeader>
                                <CardTitle>Send via Bitcoin</CardTitle>
